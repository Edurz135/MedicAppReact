...
const Medico_Comentarios5 = () => {
    return <div>
    <section className="paginacion">
      <ul>
        Filtrado Puntuación en:
        <li><a href="iniciomedico_comentarios1.page.jsx">1</a></li>
        ...
        <li><a href="iniciomedico_comentarios5.page.jsx" className="active">5</a></li>
      </ul>
    </section>
...
export default Medico_Comentarios5
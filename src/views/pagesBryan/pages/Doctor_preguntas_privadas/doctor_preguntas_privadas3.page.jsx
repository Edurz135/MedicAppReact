...
const Doctor_Preguntas_Privadas3 = () => {
...
<section className="paginacion">    
    <ul>
        <li> <a href="doctor_preguntas_privadas1.page.jsx" >1</a></li>
        <li> <a href="doctor_preguntas_privadas2.page.jsx" >2</a></li>
        <li> <a href="doctor_preguntas_privadas3.page.jsx" className="active">3</a></li>
    </ul>
</section>
</div>
}
export default Doctor_Preguntas_Privadas3
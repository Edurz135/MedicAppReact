// MAIN
export { default as MainPage } from "./mainPages/mainPage/mainPage.page";
export { default as LoginPage } from "./mainPages/loginPage/loginPage.page";
export { default as RegisterDoctorPage } from "./mainPages/registerDoctorPage/registerDoctorPage.page";
export { default as RegisterPatientPage } from "./mainPages/registerPatientPage/registerPatientPage.page";
...
export { default as DoctorMedicalRecord } from "./doctorPages/doctorMedicalRecord/doctorMedicalRecord.page";
